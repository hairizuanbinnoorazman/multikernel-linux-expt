...
ASSETS = {
    ...
    "libexec/materialize-runtime-binds.py": REPO / "scripts/materialize-runtime-binds.py",
...
LINKS = {
    ...
    Path("/usr/local/libexec/multikernel/materialize-runtime-binds.py"): "libexec/materialize-runtime-binds.py",
