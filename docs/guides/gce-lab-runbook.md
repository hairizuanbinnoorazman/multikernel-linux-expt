# GCE Multikernel Linux laboratory runbook

This guide preserves the verified procedure for evaluating Multikernel Linux
`v7.0-mk2` on Google Compute Engine. Experiment results are indexed under
[`../experiments/`](../experiments/README.md); future runtime work is under
[`../runtime/`](../runtime/README.md).

## Guide map

- [Current status and experiment outcome](#status)
- [Reproduce the verified path](#reproduce-the-verified-path)
- [Version pins and architecture](#version-pins)
- [Build and validate the primary kernel](#phase-1-prepare-the-build-environment)
- [Install Kerf and manage child resources](#phase-4-install-kerf-v020)
- [Boot and stop a child](#phase-7-load-and-start-the-child)
- [Recovery](#recovery)
- [Remaining experiments and open questions](#experiments-after-the-smoke-test)
...
executed; see the [DAXFS report](../experiments/daxfs/report.md).
...
were deleted. See the
[direct ext4 learnings](../experiments/ext4-direct/learnings.md).
The complete pass/blocked matrix is in
[the execution record](../experiments/ext4-direct/execution.md).
The follow-up primary-mediated implementation passed its core two-child
persistent-root objective; see the
[mediated ext4 report](../experiments/ext4-mediated/report.md).

## Status

Research and implementation began on 2026-08-28. The final experimental VM was
deleted after the mediated-storage work; the retained storage disk is detached.
...
| Laboratory VM | Deleted; no Compute Engine instances remain |
| Boot disk | Final 100 GiB auto-delete boot disk deleted with the VM |
| Mediated storage disk | Retained detached 20 GiB `pd-balanced`; contains outer ext4 and two 4 GiB images |
...
| Current disposition | No VM remains; the mediated-storage disk and retained recovery snapshots remain billable |
...
[the DAXFS report](../experiments/daxfs/report.md). Raw transcripts are
indexed under
[`../../evidence/daxfs-20260828/`](../../evidence/daxfs-20260828/), including
...
[the DAXFS report](../experiments/daxfs/report.md) for the result matrix and
...
passed and is recorded in the
[field notes](../experiments/field-notes-20260828.md) and
